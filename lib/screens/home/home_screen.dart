...
import 'package:flutter_netflix/screens/components/label_icon.dart';
import 'package:flutter_netflix/screens/components/play_button.dart';
import 'package:flutter_netflix/screens/components/small_sub_text.dart';
import 'package:flutter_netflix/screens/home/components/poster.dart';
import 'package:flutter_netflix/screens/home/components/rank_poster.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildInfoBottomSheet(context) {
    return Wrap(
      children: [
        Stack(
          children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  '버니가 좋아하는 나비들 중 2마리가 죽고 버니 자신에게 공격이 오자 버니는 온순한 자연을 뒤로 하고 2마리의 나비로 인해 복수할 계획들을 치밀히 세운다.'),
                            ],
                          ),
                        ),
                      ],
